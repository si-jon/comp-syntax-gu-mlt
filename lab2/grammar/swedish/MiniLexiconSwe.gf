...
lin break_V2 = mkV2 (mkV "bryta" "bryter" "bröt" "brutit" "bryt") ;
lin buy_V2 = mkV2 (mkV "köpa" "köper" "köpte" "köpt" "köp") ;
...
lin drink_V2 = mkV2 (mkV "dricka" "dricker" "drack" "druckit" "drick") ;
lin eat_V2 = mkV2 (mkV "äta" "äter" "åt" "ätit" "ät") ;
...
lin go_V = mkV "åka" "åker" "åkte" "åkt" "åk" ;
...
lin know_VS = mkVS (mkV "veta" "vet" "visste" "vetat" "vet") ;
lin language_N = mkN "språk" Neutr ;
lin live_V = mkV "leva" "lever" "levde" "levt" "lev" ;
...
lin play_V = mkV "leka" "leker" "lekte" "lekt" "lek" ;
lin read_V2 = mkV2 (mkV "läsa" "läser" "läste" "läst" "läs") ;
lin ready_A = mkA "redo" "redo" "redo" "redo" ;
lin red_A = mkA "röd" "rött" "röda" "röda" ;
lin river_N = mkN "flod" Utr ;
lin run_V = mkV "springa" "springer" "springde" "sprungit" "spring" ;
lin sea_N = mkN "hav" Neutr ;
lin see_V2 = mkV2 (mkV "se" "ser" "såg" "sett" "se") ;
lin ship_N = mkN "skepp" Neutr ;
lin sleep_V = mkV "sova" "sover" "sov" "sovit" "sov" ;
